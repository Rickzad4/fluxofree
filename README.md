...
Main.Size = UDim2.fromOffset(200, 330)  -- Aumentado um pouco para acomodar o link do Discord
...
DiscordLink.Position = UDim2.new(0,0,0,35)  -- Logo abaixo do título
DiscordLink.BackgroundTransparency = 1
DiscordLink.Text = "discord.gg/YgS6U74ZgB"
DiscordLink.Font = Enum.Font.GothamBold
DiscordLink.TextSize = 12
DiscordLink.TextColor3 = Color3.fromRGB(200, 100, 255)  -- Mesma cor do título
DiscordLink.TextTransparency = 0.3
...
local function CreateButton(text, y, isToggle, inputValue)
    ...
    btn.MouseButton1Click:Connect(function()
        ...
        if text == "SPEED" then
            -- Primeiro botão SPEED (posição Y = 65)
            if y == 65 then
                if ligado then
                    SpeedEnabled = true
                    SpeedEnabled2 = false
                    ...
                    for _, btn2 in pairs(Main:GetChildren()) do
                        if btn2:IsA("TextButton") and btn2.Text == "SPEED" and btn2.Position.Y.Offset == 102 then
            ...
            -- Segundo botão SPEED (posição Y = 102)
            elseif y == 102 then
                if ligado then
                    SpeedEnabled2 = true
                    SpeedEnabled = false
                    ...
                    for _, btn2 in pairs(Main:GetChildren()) do
                        if btn2:IsA("TextButton") and btn2.Text == "SPEED" and btn2.Position.Y.Offset == 65 then
                            btn2.BackgroundColor3 = Color3.fromRGB(40, 0, 70)
                        end
                    end
                else
...
--------------------------------------------------
local speedBtn, speedBox = CreateButton("SPEED", 65, true, 30)
local speedBtn2, speedBox2 = CreateButton("SPEED", 102, true, 60)  -- AGORA AMBOS SÃO "SPEED"
local jumpBtn, jumpBox = CreateButton("JUMP", 139, true, 50)  -- Alterado de "INF JUMP" para "JUMP"
CreateButton("ANTI RAGDOLL", 176, false, nil)  -- Posição ajustada
CreateButton("ANTI LAG", 213, false, nil)  -- Posição ajustada
CreateButton("X-RAY", 250, false, nil)  -- Posição ajustada
CreateButton("AUTO BAT", 287, false, nil)  -- Posição ajustada
...
print("   • DISCORD: discord.gg/YgS6U74ZgB")
